...
- To get your workspace name, see the About page under [Defender for Identity settings](https://security.microsoft.com/settings/identities) in the Microsoft Defender portal.
